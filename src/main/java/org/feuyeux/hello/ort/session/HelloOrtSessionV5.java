...
public class HelloOrtSessionV5 extends HelloOrtSession{

    public HelloOrtSessionV5(String modelPath, String labelPath, float confThreshold, float nmsThreshold, int gpuDeviceId) throws OrtException, IOException {
